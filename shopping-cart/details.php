            ...
            <div class="row">
                <?php if(isset($_GET['k']) && isset($arrProducts[$_GET['k']])): ?>
                    ...
                    <div class="col-md-8 col-sm-6 mb-4">                
                        ...
                        <input type="radio" name="radSize" id="radsize1" value="14oz" checked>
                        <label for="radsize1" class="pr-3">14oz</label>
                        <input type="radio" name="radSize" id="radsize2" value="18oz">
                        <label for="radsize2" class="pr-3">18oz</label>
                        <input type="radio" name="radSize" id="radsize3" value="22oz">
                        <label for="radsize3" class="pr-3">22oz</label>
                        <input type="radio" name="radSize" id="radsize4" value="32oz">
                        <label for="radsize4" class="pr-3">32oz</label>
                        <input type="radio" name="radSize" id="radsize5" value="40oz">
                        <label for="radsize5" class="pr-3">40oz</label>                        
                        <hr>
